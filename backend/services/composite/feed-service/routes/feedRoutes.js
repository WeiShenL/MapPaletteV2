...
router.get('/user/:userId', lenientLimiter, verifyAuth, validate({ params: userIdSchema, query: paginationSchema }), asyncHandler(feedController.getUserFeed));
...
router.get('/post/:postId', lenientLimiter, optionalAuth, validate({ params: postIdSchema }), asyncHandler(feedController.getPostDetails));
